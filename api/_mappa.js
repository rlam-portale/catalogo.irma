...
export const TABELLE = {
  'Collocazioni': {
    ...
    links: {
      ...
      'Preziosi': { bridge: 'collocazioni__preziosi', role: 'src' },
      'Elettronica': { bridge: 'collocazioni__elettronica', role: 'src' },
    },
    attachments: [],
    multi: [],
  },
  ...
  'Preziosi': {
    fields: ['Titolo', 'Codice', 'Tipologia', 'Marca', 'Modello o referenza',
      'Materiale', 'Titolo metallico o caratura', 'Pietre e gemme', 'Peso g',
      'Punzoni e marchi', 'Numero di serie', 'Movimento', 'Diametro cassa mm',
      'Dimensioni', 'Epoca o anno', 'Stato di conservazione', 'Funzionante',
      'Scatola e documenti', 'Certificazione o perizia', 'Provenienza',
      'Data acquisizione', 'Prezzo acquisto', 'Valore stimato', 'Data stima', 'Note'],
    links: { 'Collocazione': { bridge: 'collocazioni__preziosi', role: 'dst' } },
    attachments: ['Foto', 'Documenti'],
    multi: [],
  },
  'Elettronica': {
    fields: ['Titolo', 'Codice', 'Tipologia', 'Marca', 'Modello', 'Numero di serie',
      'Alimentazione', 'Anno o epoca', 'Altezza cm', 'Larghezza cm', 'Profondità cm',
      'Peso kg', 'Stato di conservazione', 'Funzionante', 'Accessori e cavi', 'Difetti',
      'Specifiche tecniche', 'Ambiente', 'Provenienza', 'Data acquisizione',
      'Prezzo acquisto', 'Valore stimato', 'Data stima', 'Note'],
    links: { 'Collocazione': { bridge: 'collocazioni__elettronica', role: 'dst' } },
    attachments: ['Foto', 'Documenti'],
    multi: [],
  },
